...
<header>
    ...
    <div class="menu">
        <ul>
            <li class="menu-item hidden">
                <a href="#">Prodi Sistem Informasi - Universitas Widyatama</a></li>
            </li>
            <li class="menu-item hidden"><a href="#">Home</a></li>
            <li class="menu-item hidden"><a href="<?php echo base_url() ?>">About me</a>
            </li>
            <li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank">Education</a></li>
            </li>
        </ul>
    </div>
    ...
    <div class="heroe">
        ...
        <h1>Selamat Datang di Website Yogi Pranoto</h1>

        <h2>Ini digunakan untuk menunjukan kompetensi saya dalam menggunakan Framewirk HMVC dalam pengembangan aplikasi web serta mengelola source code menggunakan sistem kontrol versi GIT</h2>
